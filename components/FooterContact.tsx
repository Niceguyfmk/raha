            ...
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-1">
                ...
                <div className="xl:col-span-2 bg-bg-footer-card rounded-xl p-8 flex flex-col md:flex-row justify-between items-center gap-8 border border-white/5">
                    ...
                    <div className="flex gap-6 items-center">
                        ...
                        <a href="https://wa.me/971585717283?text=Hi%20Raha%20Partners,%20I'm%20interested%20in%20learning%20more%20about%20your%20services." target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#2c2c2f] flex items-center justify-center text-[#dfd9d7] hover:text-[#FA6F45] transition-all hover:scale-110">
                            <FaWhatsapp size={18} />
                        </a>
                        <button
